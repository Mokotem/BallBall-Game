...
namespace FriteCollection.Math
{
    public abstract class Math
    {
        ...
        {
            return MathF.Atan(d) * (180 / MathF.PI);
        }

        public static float Atan(Entity.Vector v1, Entity.Vector v2)
        {
            return MathF.Atan(MathF.Abs(v1.y - v2.y) / MathF.Abs(v1.x - v2.x)) * (180 / MathF.PI);
        }
